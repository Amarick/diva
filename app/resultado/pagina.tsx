          ...
          <div className="space-y-6">
            ...
            <Card className="p-8">
              ...
              <div className="mb-6 p-4 bg-muted/50 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  {skinToneDescriptions[results.skinTone as keyof typeof skinToneDescriptions] ||
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {results.recommendedStyles.map((style) => (
                  <Card key={style} className="p-6 bg-card hover:bg-accent/5 transition-colors border-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {styleDescriptions[style as keyof typeof styleDescriptions] || "Estilo único e personalizado"}
                    </p>
                  </Card>
                ))}
              </div>
